...
function login(){//切換功能
    const pageData = [
        ...
        //{ title: "番外", path: "Side_Stories",webtype: "html" },
        { 
            title: "設定➤角色", 
        ...
        { 
            ...
            children: [
                ...
                //{ title: "制度與組織", path: "world_FacOrg",webtype: "son-html" },
...
(function() {
    // 將所有點擊事件統一交給最外層的 document 老祖宗管理
    document.addEventListener("click", function(e) {
    // 1. 💥 檢查：點擊的是不是包含 .menu-btn 的元件？
        ...
        // 2. 💥 檢查：點擊的是不是 id="site-name" 的回到首頁按鈕？
